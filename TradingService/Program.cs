...
// Register Trading-specific repositories
...
logger.LogInformation("TradingService starting up...");
...
app.UseSwaggerUI(c =>
{
    ...
    c.DocumentTitle = "Trading Service Documentation";
    c.EnableDeepLinking();
...
logger.LogInformation("TradingService started successfully");
app.Run();
